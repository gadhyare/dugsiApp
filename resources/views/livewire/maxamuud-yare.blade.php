<div>
    <div class="card border-0 p-3 shadow-lg">
        ...
        @endif
        <div>
            <a href="{{ route('students.register') }}" class="btn bg-red-500 text-white fw-bold float-start"> تسجيل طالب
                جديد </a>
        </div>
        <br>
        @php
        ...
        <table class="table border">
            <thead>
                <tr>
                    ...
                    <th class="bg-blue-700 text-blue-100">التعديل</th>
                    <th class="bg-blue-700 text-blue-100">الحذف</th>
                </tr>
            </thead>
            <tbody>
                ...
                @foreach ($students as $student)
                    <tr>
                        ...
                        <td>
                            ...
                            <img src="{{ Storage::url('/uploads/' . $src) }}" class="rounded-circle shadow-lg"
                                style="width:30px; height: 30px" />
                        </td>
                        <td>
                            <div class="dropdown">
                                <button class="border-0 dropdown-toggle bg-blue-700 text-blue-100 rounded-1"
                                    type="button" id="dropdownMenuButton{{ $student->id }}" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <span>العمليات</span>
                                </button>
